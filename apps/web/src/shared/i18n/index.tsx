...
const commonApiErrorMessages: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    cloud_resync_failed: "云端重新同步失败。",
    cloud_restore_failed: "云端恢复失败。",
    cloud_url_refresh_failed: "云端链接刷新失败。",
  ...
  en: {
    ...
    cloud_resync_failed: "Cloud resync failed.",
    cloud_restore_failed: "Cloud restore failed.",
    cloud_url_refresh_failed: "Cloud link refresh failed.",
...
const zhMessages = {
  ...
  galleryActionCopyCloudLink: ({ excerpt }: { excerpt: string }) => `复制云端链接：${excerpt}`,
  ...
  galleryActionRestoreCloud: ({ excerpt }: { excerpt: string }) => `从云端恢复本地缓存：${excerpt}`,
  galleryActionReusePrompt: ({ excerpt }: { excerpt: string }) => `复用提示词：${excerpt}`,
  galleryActionResyncCloud: ({ excerpt }: { excerpt: string }) => `重新同步到 my_tools：${excerpt}`,
  galleryBadgeLatest: "最新",
  galleryCloudCopyLink: "复制云端链接",
  galleryCloudDeleted: "云端已删除",
  galleryCloudFailed: "同步失败",
  galleryCloudLinkCopied: "已复制云端链接。",
  galleryCloudMissing: "云端缺失",
  galleryCloudNotSynced: "未同步",
  galleryCloudPending: "云端待确认",
  galleryCloudRestore: "恢复",
  galleryCloudRestored: "已从 my_tools 恢复本地缓存。",
  galleryCloudResync: "重同步",
  galleryCloudResynced: "已重新同步到 my_tools。",
  galleryCloudStatusLabel: "云端状态",
  galleryCloudUploaded: "云端已同步",
  ...
  galleryExportStarted: "Gallery ZIP 下载已开始。",
  galleryExportZip: "导出 ZIP",
  ...
  storageMyToolsAvailable: "my_tools 存储由环境变量配置，当前可用。",
  storageMyToolsMissing: "my_tools 存储需要 MY_TOOLS_BASE_URL 和 MY_TOOLS_STORAGE_SHARED_SECRET。",
  storageProviderLabel: "存储服务",
  storageProviderOption: ({ provider }: { provider: string }) =>
    provider === "cos" ? "腾讯 COS" : provider === "s3" ? "S3/R2" : "my_tools",
  storageS3ForcePathStyle: "使用 path-style 地址",
  storageSubtitle: "选择 my_tools、腾讯云 COS 或 S3-compatible 存储，生成图保存后同步上传。",
  storageTest: "测试",
...
const enMessages: I18nMessages = {
  ...
  galleryActionCopyCloudLink: ({ excerpt }) => `Copy cloud link: ${excerpt}`,
  ...
  galleryActionRestoreCloud: ({ excerpt }) => `Restore local cache from cloud: ${excerpt}`,
  galleryActionReusePrompt: ({ excerpt }) => `Reuse prompt: ${excerpt}`,
  galleryActionResyncCloud: ({ excerpt }) => `Resync to my_tools: ${excerpt}`,
  galleryBadgeLatest: "Latest",
  galleryCloudCopyLink: "Copy cloud link",
  galleryCloudDeleted: "Cloud deleted",
  galleryCloudFailed: "Sync failed",
  galleryCloudLinkCopied: "Cloud link copied.",
  galleryCloudMissing: "Cloud missing",
  galleryCloudNotSynced: "Not synced",
  galleryCloudPending: "Cloud pending",
  galleryCloudRestore: "Restore",
  galleryCloudRestored: "Local cache restored from my_tools.",
  galleryCloudResync: "Resync",
  galleryCloudResynced: "Resynced to my_tools.",
  galleryCloudStatusLabel: "Cloud status",
  galleryCloudUploaded: "Cloud synced",
  ...
  galleryExportStarted: "Gallery ZIP download started.",
  galleryExportZip: "Export ZIP",
  ...
  storageMyToolsAvailable: "my_tools storage is configured by environment variables and is available.",
  storageMyToolsMissing: "my_tools storage requires MY_TOOLS_BASE_URL and MY_TOOLS_STORAGE_SHARED_SECRET.",
  storageProviderLabel: "Storage provider",
  storageProviderOption: ({ provider }) => (provider === "cos" ? "Tencent COS" : provider === "s3" ? "S3/R2" : "my_tools"),
  storageS3ForcePathStyle: "Use path-style URLs",
  storageSubtitle: "Choose my_tools, Tencent Cloud COS, or S3-compatible storage to sync generated images after save.",
  storageTest: "Test",
  storageTestFailed: "Cloud storage test failed.",
